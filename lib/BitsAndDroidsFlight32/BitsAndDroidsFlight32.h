...
#ifndef _BITSANDDROIDSFLIGHT32_H_
#define _BITSANDDROIDSFLIGHT32_H_
...
class [[maybe_unused]] BitsAndDroidsFlight32 {
...
public:
    ...
    void sendSetYokeAxis(byte elevatorPin, bool reversedElevator, byte aileronPin, bool reversedAileron, int minVal,
                         int maxVal);
    ...
    int getFeetAboveGround() const { return feetAboveGround; };
    ...
    // Ap
    int getApVerticalSpeed() const { return apVerticalSpeed; };

    int getApAltLock() const { return apAltLock; };

    // GPS
    int getGpsCourseToSteer() const { return gpsCourseToSteer; };

    // Avionics
    int getApHeadingLock() const { return apHeadingLock; };

    int getKohlmanAltimeter() const { return kohlmanAltimeter; };

    int getBarPressure() const { return barPressure; };

    byte getFuelTotalPercentage() const { return fuelTotalPercentage; };

    int getIndicatedAirspeed() const { return indicatedAirspeed; };

    int getIndicatedAltitude() const { return indicatedAltitude; };

    int getIndicatedHeading() const { return indicatedHeading; };

    int getIndicatedGPSGroundspeed() const { return indicatedGPSGroundspeed; };

    int getTrueVerticalSpeed() const { return trueVerticalSpeed; };

    int getLastPrefix() const;

    // Lights
    bool getLightTaxiOn() const { return lightTaxiOn; };

    bool getLightStrobeOn() const { return lightStrobeOn; };

    bool getLightPanelOn() const { return lightPanelOn; };

    bool getLightRecognitionOn() const { return lightRecognitionOn; };

    bool getLightWingOn() const { return lightWingOn; };

    bool getLightLogoOn() const { return lightLogoOn; };

    bool getLightCabinOn() const { return lightCabinOn; };

    bool getLightHeadOn() const { return lightHeadOn; };

    bool getLightBrakeOn() const { return lightBrakeOn; };

    bool getLightNavOn() const { return lightNavOn; };

    bool getLightBeaconOn() const { return lightBeaconOn; };

    bool getLightLandingOn() const { return lightLandingOn; };

    // Coms
    long getActiveCom1() const { return activeCom1; };

    long getActiveCom2() const { return activeCom2; };

    long getStandbyCom1() const { return standByCom1; };

    long getStandbyCom2() const { return standByCom2; };

    long getActiveNav1() const { return activeNav1; };

    long getActiveNav2() const { return activeNav2; };

    long getStandbyNav1() const { return standbyNav1; };

    long getStandbyNav2() const { return standbyNav2; };

    String getNavRadialError1() { return navRadialError1; };

    String getNavVorLationalt1() { return navVorLationalt1; };

    int getNavObs1() const { return navObs1; };

    int getNavObs2() const { return navObs2; };

    // Warnings
    bool getStallWarningOn() const { return stallWarning; };

    bool getOverspeedWarningOn() const { return overspeedWarning; };


    // flaps
    byte getFlapsHandlePct() const { return flapsHandlePct; };

    byte getFlapsHandleIndex() const { return flapsHandleIndex; };

    byte getFlapsNumHandlePos() const { return flapsNumHandlePos; };

    byte getTrailingEdgeFlapsLeftPercent() const { return trailingEdgeFlapsLeftPercent; };

    byte getTrailingEdgeFlapsRightPercent() const { return trailingEdgeFlapsRightPercent; };

    int getTrailingEdgeFlapsLeftAngle() const { return trailingEdgeFlapsLeftAngle; };

    int getTrailingEdgeFlapsRightAngle() const { return trailingEdgeFlapsRightAngle; };

    byte getLeadingEdgeFlapsLeftPct() const { return leadingEdgeFlapsLeftPct; };

    byte getLeadingEdgeFlapsRightPct() const { return leadingEdgeFlapsRightPct; };

    int getLeadingEdgeFlapsLeftAngle() const { return leadingEdgeFlapsLeftAngle; };

    int getLeadingEdgeFlapsRightAngle() const { return leadingEdgeFlapsRightAngle; };

    // Gears
    bool getGearHandlePos() const { return gearHandlePos; };

    int getGearHydraulicPressure() const { return gearHydraulicPressure; };

    bool getTailWheelLock() const { return tailWheelLock; };

    byte getGearCenterPositionPct() const { return gearCenterPositionPct; };

    byte getGearLeftPositionPct() const { return gearLeftPositionPct; };

    byte getGearRightPositionPct() const { return gearRightPositionPct; };

    byte getGearTailPositionPct() const { return gearTailPositionPct; };

    byte getGearAuxPosition() const { return gearAuxPosition; };

    byte getGearTotalPct() const { return gearTotalPct; };

    // Rudder/Trim
    int getAileronTrimPct() const { return aileronTrimPct; };

    int getAileronTrimDegr() const { return aileronTrimDegr; };

    int getRudderTrimDegr() const { return rudderTrimDegr; };

    int getRudderTrimPct() const { return rudderTrimPct; };

    int getElevatorTrimPos() const { return elevatorTrimPos; };

    int getElevatorTrimPct() const { return elevatorTrimPct; };
    ...
    // AP
    bool getAPAvailable() const { return APAvailable; };

    bool getAPMasterOn() const { return APMasterOn; };

    bool getAPWingLevelerOn() const { return APWingLevelerOn; };

    bool getAPNav1LockOn() const { return APNav1LockOn; };

    bool getAPHeadingLockOn() const { return APHeadingLockOn; };

    bool getAPAltitudeLockOn() const { return APAltitudeLockOn; };

    bool getAPAttitudeLockOn() const { return APAttitudeLockOn; };

    bool getAPGlideslopeHoldOn() const { return APGlideslopeHoldOn; };

    bool getAPApproachHoldOn() const { return APApproachHoldOn; };

    bool getAPBackcourseHoldOn() const { return APBackcourseHoldOn; };

    bool getAPFlightDirectorOn() const { return APFlightDirectorOn; };

    bool getAPAirspeedHoldOn() const { return APAirspeedHoldOn; };

    bool getAPMachHoldOn() const { return APMachHoldOn; };

    bool getAPYawDampenerOn() const { return APYawDampenerOn; };

    bool getAPAutothrottleArm() const { return APAutothrottleArm; };

    bool getAPTakeoffPowerOn() const { return APTakeoffPowerOn; };

    bool getAPAutothrottleOn() const { return APAutothrottleOn; };

    bool getAPVerticalHoldOn() const { return APVerticalHoldOn; };

    bool getAPRPMHoldOn() const { return APRPMHoldOn; };

    bool getParkingBrakeIndicator() const { return parkingBrakeIndicator; };

    byte getFuelTankCenterLevel() const { return fuelTankCenterLevel; };

    byte getFuelTankCenter2Level() const { return fuelTankCenter2Level; };

    byte getFuelTankCenter3Level() const { return fuelTankCenter3Level; };

    byte getFuelTankLeftMainLevel() const { return fuelTankLeftMainLevel; };

    byte getFuelTankLeftAuxLevel() const { return fuelTankLeftAuxLevel; };

    byte getFuelTankLeftTipLevel() const { return fuelTankLeftTipLevel; };

    byte getFuelTankRightMainLevel() const { return fuelTankRightMainLevel; };

    byte getFuelTankRightAuxLevel() const { return fuelTankRightAuxLevel; };

    byte getFuelTankRightTipLevel() const { return fuelTankRightTipLevel; };

    byte getFuelTankExternal1Level() const { return fuelTankExternal1Level; };

    byte getFuelTankExternal2Level() const { return fuelTankExternal2Level; };

    int getFuelTankCenter() const { return fuelTankCenterCapacity; };

    int getFuelTankCenter2() const { return fuelTankCenter2Capacity; };

    int getFuelTankCenter3() const { return fuelTankCenter3Capacity; };

    int getFuelTankLeftMainCapacity() const { return fuelTankLeftMainCapacity; };

    int getFuelTankLeftAuxCapacity() const { return fuelTankLeftAuxCapacity; };

    int getFuelTankLeftTipCapacity() const { return fuelTankLeftTipCapacity; };

    int getFuelTankRightMainCapacity() const { return fuelTankRightMainCapacity; };

    int getFuelTankRightAuxCapacity() const { return fuelTankRightAuxCapacity; };

    int getFuelTankRightTipCapacity() const { return fuelTankRightTipCapacity; };

    int getFuelTankExternal1Capacity() const { return fuelTankExternal1Capacity; };

    [[maybe_unused]] [[nodiscard]] int getFuelTankExternal2Capacity() const { return fuelTankExternal2Capacity; };

    float getFuelTankLeftCapacity() const { return fuelTankLeftCapacity; };

    float getFuelTankRightCapacity() const { return fuelTankRightCapacity; };

    int getFuelTankCenterQuantity() const { return fuelTankCenterQuantity; };

    int getFuelTankCenter2Quantity() const { return fuelTankCenter2Quantity; };

    int getFuelTankCenter3Quantity() const { return fuelTankCenter3Quantity; };

    int getFuelTankLeftMainQuantity() const { return fuelTankLeftMainQuantity; };

    int getFuelTankLeftAuxQuantity() const { return fuelTankLeftAuxQuantity; };

    int getFuelTankLeftTipQuantity() const { return fuelTankLeftTipQuantity; };

    int getFuelTankRightMainQuantity() const { return fuelTankRightMainQuantity; };

    int getFuelTankRightAuxQuantity() const { return fuelTankRightAuxQuantity; }

    int getFuelTankRightTipQuantity() const { return fuelTankRightTipQuantity; };

    int getFuelTankExternal1Quantity() const { return fuelTankExternal1Quantity; };

    int getFuelTankExternal2Quantity() const { return fuelTankExternal2Quantity; };

    float getFuelTankLeftQuantity() const { return fuelTankLeftQuantity; };

    float getFuelTankRightQuantity() const { return fuelTankRightQuantity; };

    int getFuelTankTotalQuantity() const { return fuelTankTotalQuantity; };
    ...
    float getFuelUsed() { return fuelUsed; };

    float getFuelFlowEng1() { return fuelFlowEng1; };

    float getFuelFlowEng2() { return fuelFlowEng2; };

    float getFuelQuantity() { return fuelQuantity; };

    int getTestAlt() { return testAlt; };

    int getTestHeading() { return testHeading; };

    //int getEltState(){return eltState;};
    int getEltState() { return eltState; };

    int getRpmEng1() { return rpmEng1; };

    int getRpmEng2() { return rpmEng2; };

    int getCurAltC() { return curAltC; };

    int getTestInt() const { return testInt; };

    float getTestFloat() const { return testFloat; };
    bool getLGreenPress() const{ return lGreenPress;};

    bool getLBluePress() const{ return lBluePress;};

    bool getLightTestConcorde() const{ return lightTestConcorde;};
    bool getTestBool() const { return testBool; };
...
private:
    ...
    bool lGreenPress = false;

    bool lBluePress = false;
    bool lightTestConcorde = false;
    //--------------------------------------------
    // TRANSMIT DATA
    ...
    static String convertToFreq(const String &unprocVal);

    static String convertToNavFreq(const String &unprocVal);
...
#endif //_BITSANDDROIDSFLIGHT32_H_
